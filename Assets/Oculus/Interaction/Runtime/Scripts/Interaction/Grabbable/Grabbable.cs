...
namespace Oculus.Interaction
{
    ...
    {
         //edited: woan ning
        public bool includeInExperiment;
        ...
        {
             //edited: woan ning
            //hv = GameObject.FindWithTag("HV").GetComponent<HandVisual>();  //not using at the moment
            isGrabbed = false;            
            move = false;
        ...
        private void UpdateTransform()
        {
            ...
            else
            {
                if (move)
                {
                    _activeTransformer.UpdateTransform();
                    //edited: woan ning
                    //added this section to alter the object position
                    gameObject.transform.position = newPosition;                    
                    //Debug.Log("woan ning: object" + gameObject.transform.position.x + "," + gameObject.transform.position.y + "," + gameObject.transform.position.z);
                }
            }
            
        }
        //edited by woan ning, change the EndTransform method to public, original is 'private'
